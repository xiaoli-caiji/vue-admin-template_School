    ...
    <el-tabs type="card">
      <el-tab-pane label="在线投稿">
        <el-form ref="form" :model="form" label-width="120px">
          ...
          <el-form-item id="addPicture1" label="上传图片：">
            <el-upload
              ref="uploadPicture"
      ...
      <el-tab-pane label="已有上传">
        <el-form ref="form" :model="form" label-width="120px">
          ...
          <el-form-item id="addPicture2" label="上传图片：">
            <el-upload
              ref="uploadPicture"
              action="https://localhost:13001/api/UserSelfSetting/ReceiveHeadImg"
              name="NewsCoverImg"
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      console.log(this.NewsPictureList)
